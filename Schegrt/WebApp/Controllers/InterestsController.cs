    ...
    public class InterestsController : Controller
    {
        ...
        public ActionResult Create(InterestViewModel interest)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("Index", user is StudentUser ? "students" : "providers", null);
            }
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            db.SaveChanges();
            return RedirectToAction("Index", db.Users.FirstOrDefault(x => x.Email == User.Identity.Name) is StudentUser ? "students" : "providers", null);
        }
